#!/usr/bin/env python3
"""Reproduce Nunchaku's recommended FLUX.1-schnell W4A4 example."""
...
QUANT_MODEL = "mit-han-lab/svdq-int4-flux.1-schnell"
PROMPT = "A cat holding a sign that says hello world"
SEEDS = (42, 43, 44)


def main() -> None:
    output_dir = Path("outputs/flux_official_reproduction")
    ...
    report = {
        ...
        "base_model_note": "byte-equivalent ungated Diffusers mirror of official FLUX.1-schnell",

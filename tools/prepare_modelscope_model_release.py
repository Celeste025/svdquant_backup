...
SPECS = (
    Spec("rcm-wan", "svdquant-rcm-wan2.1-1.3b", "real-nvfp4-g5-r32",
         CKPTS / "rcm-wan2.1-1.3b-real-nvfp4-s16", ("model.pt", "scale.pt", "wgts.pt", "smooth.pt", "branch.pt"),
         ...
         license_source=DATA / "models/Wan2.1-T2V-1.3B/LICENSE.txt", cache_tag="rcm-wan2.1-1.3b-real-nvfp4-s16"),
    ...
    Spec("rcm-wan", "svdquant-rcm-wan2.1-1.3b", "real-nvfp4-g20-r32",
         CKPTS / "rcm-wan2.1-1.3b-real-nvfp4-s16-g20-r32", ("model.pt", "scale.pt", "wgts.pt", "smooth.pt", "branch.pt", "manifest.json"),
         ...
         license_source=DATA / "models/Wan2.1-T2V-1.3B/LICENSE.txt", cache_tag="rcm-wan2.1-1.3b-real-nvfp4-s16-g20-r32"),
    Spec("rcm-wan", "svdquant-rcm-wan2.1-1.3b", "real-nvfp4-g10-r64",
         CKPTS / "rcm-wan2.1-1.3b-real-nvfp4-s16-g10-r64", ("model.pt", "scale.pt", "wgts.pt", "smooth.pt", "branch.pt", "manifest.json"),
         ...
         license_source=DATA / "models/Wan2.1-T2V-1.3B/LICENSE.txt", cache_tag="rcm-wan2.1-1.3b-real-nvfp4-s16-g10-r64"),
